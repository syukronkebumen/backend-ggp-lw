            ...
            <div class="modal-body">
                <form wire:submit.prevent="store">
                    <div class="mb-3">
                        ...
                        <input id="departement" type="text" placeholder="Departement" wire:model="departement" class="form-control @error('departement') is-invalid @enderror" aria-describedby="emailHelp">
                        @error('departement')
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form wire:submit.prevent="update">
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Departement</label>
                        <input id="departement" type="text" wire:model="departement" class="form-control @error('departement') is-invalid @enderror" placeholder="Departement">
                        @error('departement')
                        <span class="invalid-feedback">
                                {{ $message }}
                        </span>
